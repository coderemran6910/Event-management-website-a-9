  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center justify-center py-10  w-2/4 mx-auto text-center mt-20">
        ...
        <p className="py-6 ">Welcome to PRO EVENT HANDLER, your premier destination for creating
            unforgettable social events and dream weddings. We understand that
            every event is a unique celebration of love, joy, and togetherness.</p>
      </div>
    

      <div className=" grid grid-cols-1 md:grid-cols-2  max-h-[80vh]  justify-items-center overflow-hidden">
