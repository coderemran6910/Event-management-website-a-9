...
<div data-aos="fade-up" data-aos-duration="1200" className="flex flex-col items-center justify-center py-10  w-2/4 mx-auto text-center mt-20">
...
<div className=" grid grid-cols-1 md:grid-cols-2    justify-items-center overflow-hidden">
  ...
  <div data-aos="fade-left" data-aos-duration="2000" className="bg-gray-100 py-12 px-5">
